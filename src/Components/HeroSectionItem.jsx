              ...
              <div className=" gap-8 grid grid-cols-6 h-[360px]">
                ...
                <div className=" text-black p-3 flex flex-col items-start rounded-lg col-span-4 shadow-lg bg-slate-200">
                  ...
                  <div className=" mt-auto mb-3 px-5 w-full flex flex-row justify-between items-center">
                    ...
                    <button disabled={inCart} onClick={handleCartProducts} className=" disabled:after:content-['Added'] disabled:pointer-events-none after:content-['Add_to_Cart'] disabled:bg-red-600 px-3 py-2 rounded-md text-black hover-1 flex items-end justify-center gap-2">
                      {" "}
