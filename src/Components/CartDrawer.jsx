...
const CartDrawer = ({}) => {
  ...
  const total = carts.reduce((pv, cv) => pv + cv.cost, 0);
  ...
  return (
    <div className=" select-none">
      <div
        ...
        } backdrop-blur-sm p-5 duration-700 translate-x-[500px] z-[999999999] fixed top-6 right-5 bg-slate-400 bg-opacity-60 h-[650px] w-[450px] rounded-2xl`}
      >
        <div className=" flex flex-col h-full">
          ...
          <div className=" h-[450px] my-3 p-1 scroll-smooth">
            <div className=" scrollbar-hide flex flex-col bg-white rounded-lg h-full overflow-x-hidden overflow-y-auto">
              <div className=" font-medium mx-6 flex items-center justify-between">
                <p>Products</p>
                <p>Qty</p>
                <p>Cost</p>
                <p>Del</p>
              ...
              {carts.length === 0 ? (
                <div className=" duration-200 flex">
                  <svg
                  className=" my-20 h-[150px] w-full"
                    xmlns="http://www.w3.org/2000/svg"
                    data-name="Layer 1"
                    width="896"
                    height="747.97143"
